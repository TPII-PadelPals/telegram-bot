...
COMMANDS = ["/start", "/help", "/registrarse", "/configurar_disponibilidad", "/ver_emparejamientos", "/configurar_golpes", "/ver_reservas", "/rechazar_emparejamiento", "/encuesta_jugador", "/configurar_ubicacion"]
SEPARATOR_OF_DATA = ": "
